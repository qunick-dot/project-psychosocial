    ...
    <div class="sidebar">
      ...
      <div class="sidebar-menu">
        <ul>
          ...
          <li><a href="<?php echo e(route('admin.blog.index')); ?>"><i class="fas fa-blog"></i> Blog Posts</a></li>
                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $consultations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consultation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          ...
                          <td><?php echo e($consultation->phone); ?></td>
                          <td><?php echo e($consultation->preferred_date->format('F d, Y')); ?></td>
                          <td><?php echo e($consultation->consultant); ?></td>
                          <td>
                              <span class="status-badge <?php echo e(strtolower($consultation->status)); ?>">
                                  <?php echo e($consultation->status); ?>

                              </span>
                          </td>
                          <td>
                              <form method="POST" action="<?php echo e(route('consultations.update-status', $consultation->id)); ?>">
                                  <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\xampp\htdocs\Psychoresearch\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>