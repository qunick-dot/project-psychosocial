...
unset($__errorArgs, $__bag); ?>" name="title" value="<?php echo e(old('title')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>" name="category" value="<?php echo e(old('category')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-10">
                                <textarea id="excerpt" class="form-control <?php $__errorArgs = ['excerpt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="excerpt" required><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="content" rows="10" required><?php echo e(old('content')); ?></textarea>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" <?php echo e(old('published') ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Psychoresearch\resources\views\admin\blog\create.blade.php ENDPATH**/ ?>